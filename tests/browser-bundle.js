...
"use strict";
const modules={
"tests/browser-entry.tsx":function(module,exports,require){
"use strict";
...
(0, mount_tsx_1.mount)((0, api_ts_1.parseLocation)(window.__testLocation || 'https://jenkins.test/job/bus_backend/job/BUS-4497-agent-flow-improvements/'));
const flow = __importStar(require("src/flow-table.ts"));
window.__flowTest = flow;
...
require("tests/browser-entry.tsx");
})();
